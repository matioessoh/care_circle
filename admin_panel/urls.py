...
urlpatterns = [
    ...
    path('users/<int:user_id>/deactivate/', views.user_deactivate, name='admin_user_deactivate'),
    path('doctors/', views.doctor_list_admin, name='admin_doctors'),
    path('doctors/new/', views.doctor_create, name='admin_doctor_create'),
    path('doctors/new/account/', views.doctor_account_create, name='admin_doctor_account_create'),
    ...
    path('doctors/<int:doctor_id>/deactivate/', views.doctor_deactivate, name='admin_doctor_deactivate'),
    ...
    path('forum/communities/', views.communities_list, name='admin_communities'),
    path('forum/communities/new/', views.community_create, name='admin_community_create'),
    path('forum/communities/<int:community_id>/edit/', views.community_edit, name='admin_community_edit'),
    path('forum/communities/<int:community_id>/delete/', views.community_delete, name='admin_community_delete'),
    path('forum/communities/<int:community_id>/toggle-active/', views.community_toggle_active, name='admin_community_toggle_active'),
